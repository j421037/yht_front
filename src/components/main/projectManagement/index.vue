...
<template>
    <div class="projectManagementBox">
                                ...
                                >
                                    ...
                                    <el-table-column label="跟踪动态">
                                        <template slot-scope="scope">
                                            <el-button
                                                size="mini"
                                                @click="onGzdtClick(scope.row.cust_id)"
                                            >
                                                <div
                                                    style="color:#d27f9b;"
                                                >{{ scope.row.coop }}</div>
                                    ...
                                    <el-table-column label="标签">
                                        <template slot-scope="scope">
                                            <el-button
                                                size="mini"
                                                @click="onBqClick(scope.row.cust_id)"
                                            >
                                                <div
                                                    style="color:#d27f9b;"
                                                >{{ scope.row.coop }}</div>
        ...
        <div class="biaoqian">
            <el-dialog title="标签" width="40%" :visible.sync="dialogTableVisibleBq">
                <el-table :data="gridDataBq" :border="true">
                    <el-table-column property="machine" label="标签" width="150"></el-table-column>
                    <el-table-column property="addtime" label="日期" width="150"></el-table-column>
