        ...
        >
            ...
            <el-form :model="Form" ref="form" :rules="Rules" label-width="120px">
                ...
                <el-form-item label="新版本号" prop="new_version" :rules="[{validator: validateVersion, trigger: 'blur'},{required:true,trigger:'blur',message:'请输入版本号'}]">
                    <el-input v-model="Form.new_version" placeholder="请输入新的版本号" class="fr-ipt-width" />
                </el-form-item>
                <el-form-item label="运费" prop="freight">
                    <el-input v-model="Form.freight" class="fr-ipt-width">
                ...
                <el-form-item label="值" prop="discount" >
                    <el-input v-model="Form.discount" placeholder="请输入调价的金额或者折扣幅度,整数" class="fr-ipt-width">
                        <template slot="append" v-if="mode == 1">元</template>
                        <template slot="append" v-if="mode == 0">百分点</template>
                    </el-input>
                </el-form-item>
                <el-form-item label="备注" prop="remark" >
                    <el-input v-model="Form.remark" placeholder="请输入调价的信息" class="fr-ipt-width"/>
                </el-form-item>
            </el-form>
...
<script>
    export default {
        data() {
            ...
            return {
                ...
                Rules: {
                    ...
                    freight: [
                        {required: true, trigger: "blur", message: "请输入运费，默认0"}
                    ]
                },
                submiting: false,
                remoteLoading: false,
        ...
        methods: {
            ...
            /**版本切换**/
            handleVersionChanged(val) {
                let it = this.PriceVersions.find(item => {return item.value == val;});

                if (typeof(it) != "undefined")
                    this.Form.freight = it.freight;
            },
            /**
             * 品牌切换
             * **/
