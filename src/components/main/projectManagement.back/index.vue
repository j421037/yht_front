                            ...
                            <div class="proTop">
                                <table style="width:100%;">
                                    <tr>
                                        ...
                                        <td>品牌库：</td>
                                        <td>
                                            <a :href="props.row.projectInfo.brand">点击查看</a>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="width:100px;"></td>
                                ...
                                >
                                    ...
                                    <el-table-column label="跟踪动态">
                                        <template slot-scope="scope">
                                            <el-button
                                                size="mini"
                                                @click="onGzdtClick(scope.row.id)"
                                            >
                                                <div
                                                    style="color:#d27f9b;"
                                                >查看</div>
                                            ...
                                            <el-button
                                                size="mini"
                                                @click="addGzdt(scope.row.id,scope.row.user_id)"
                                            >
                                                <div
                                                    style="color:#d27f9b;"
                                                >添加</div>
                                    ...
                                    <el-table-column label="标签" width="200">
                                        <template slot-scope="scope">
                                            ...
                                            <el-button
                                                size="mini"
                                                @click="addPtjq(scope.row.id,scope.row.user_id)"
                                            >
                                                <div
                                                    style="color:#d27f9b;"
                                                >添加配套机器</div>
                                            ...
                                            <el-button
                                                size="mini"
                                                @click="addSjju(scope.row.id,scope.row.user_id)"
                                            >
                                                <div
                                                    style="color:#d27f9b;"
                                                >添加送检记录</div>
            ...
            <el-dialog title="添加配套机器" width="40%" :visible.sync="dialogVisibleAddPeitaojiqi">
                <el-form :model="peitaojiqi">
                    <div class="fx">
                        ...
                        <div class="fx1">
                            <el-input v-model="peitaojiqi.machine" placeholder="请输入内容"></el-input>
                        </div>
                    </div>
                    <div class="fx">
                        <div class="txt">
                ...
                <div class="wrap" style="padding:0 40px;">
                    ...
                    >
                        ...
                        <el-form-item label="挂靠">
                            <el-radio v-model="customer.attached" label="是">是</el-radio>
                            <el-radio v-model="customer.attached" label="否">否</el-radio>
                        </el-form-item>
...
export default {
    ...
    methods: {
        ...
        addGzdt(id,uid){
            ...
            this.dongtai.cust_id = id
            this.dongtai.user_id = uid
        },
        addPtjq(id,uid){
            this.dialogVisibleAddPeitaojiqi = true
            this.peitaojiqi.cust_id = id
            this.peitaojiqi.user_id = uid
        },
        addSjju(id,uid){
            this.dialogVisibleAddSongjianjilu = true
            this.songjianjilu.cust_id = id
            this.songjianjilu.user_id = uid
        },
        onPageChange(e){
            this.getAllData(e)
        },
